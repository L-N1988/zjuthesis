...
\documentclass[
    ...
    SubmitDate      = 递交日期,
    MajorFormat     = general,
		Cover           = true,						 % print cover page or not
		TOC             = true,						 % print table of content and abstract or not
...
%% Uncomment the following lines if you need multi line students' names on cover pages
\studenttwolines{学生名第一行}{学生名第二行}
...
\newcommand{\inputundergraduate}
{
    \ifthenelse{\equal{\Period}{paper}}
    {
        ...
        \newrefsection
				...
				\ifthenelse{\equal{\Cover}{true}}{
					\coverstyle
					\inputpage{final}{cover}
				}
				{}

				\ifthenelse{\equal{\TOC}{true}}{
					\prevstyle
					\inputpage{final}{previous} % abstract
					\inputpage{final}{toc} % table of content
				}
				{}
